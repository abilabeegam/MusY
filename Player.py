...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack = tk.Label(self.track, font=("times new roman",16,"bold"),
						bg="black",fg="white")
		self.songtrack['text'] = 'MusY MP3 Player'
		self.songtrack.config(width=30, height=1)
		self.songtrack.grid(row=2,column=0,padx=10)

	def control_widgets(self):
		self.loadSongs = tk.Button(self.controls, bg='black', fg='white', font=10, image=add)
...
add = PhotoImage(file='images/add1.gif')
